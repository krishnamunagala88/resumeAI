...
def generate_pdf(tex_file: str, cls_file: str, output_dir: str = "output_modified") -> str:
    ...
    try:
        ...
        # Get the PDF filename (same as tex file but .pdf)
            ...
            if updated_resume:
                ...
                try:
                    ...
                    base64_pdf = generate_pdf(
                        tex_file=updated_resume_path,
                        cls_file=os.path.join(BASE_DIR, 'resume.cls'),
                        output_dir=os.path.join(BASE_DIR, 'pdf_output1')
                    )
                    
                    # Return both the updated resume and PDF
                    return JsonResponse({
                    ...
                    # Return just the resume if PDF fails
                    return JsonResponse({
...
#                 try:
#                     print("inside try")
#                     base64_pdf = generate_pdf('updated_resume.tex', 'resume.cls')
#                     print("base 64 reached")
#                     print(base64_pdf)
#                     # Now you can use base64_pdf as needed
#                 except Exception as e:
